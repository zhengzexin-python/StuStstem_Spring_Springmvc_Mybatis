...
<c:if test="${null==requestScope.standardList}">
    <c:redirect url="/GetStandardByPage"></c:redirect>
</c:if>

<table border="1">
    <tr>
        <td colspan="7">
            <form action="/GetStandardByPage" method="post" style="display: inline">
...
<a href="/GetStandardByPage?pageIndex=1&select=${requestScope.select}">首页</a>
<a href="/GetStandardByPage?pageIndex=${requestScope.page.prevPage}&select=${requestScope.select}">上一页</a>
<a href="/GetStandardByPage?pageIndex=${requestScope.page.nextPage}&select=${requestScope.select}">下一页</a>
<a href="/GetStandardByPage?pageIndex=${requestScope.page.totalPage}&select=${requestScope.select}">末页</a>
